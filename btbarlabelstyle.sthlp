...
{title:help for barlabelstyle}{break}

{p 4 4 4}{hi:barlabelstyle {hline 2}} is an optional argument for {help brewtheme}.{p_end}

     {hline 70}
{p2colset 8 50 50 8}{p2col:Keys}Values{p_end}
     {hline 70}
{p2colset 8 50 50 8}{p2col:{help scheme_graph_bar##remarks3:bar}}{stata graph query barlabelstyle}{p_end}
     {hline 70}
...
{p2colset 8 50 50 8}{p2col:Keys}Values{p_end}
     {hline 70}
{p2colset 8 50 50 8}{p2col: bar}bar{p_end}
     {hline 70}
