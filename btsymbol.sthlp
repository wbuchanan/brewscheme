...
{title:help for symbol}{break}

{p 4 4 4}{hi:symbol {hline 2}} is an optional argument for {help brewtheme}.{p_end}
...
{p2colset 8 50 50 8}{p2col:Keys}Values{p_end}
     {hline 70}
{p2colset 8 50 50 8}{p2col:ci}circle{p_end}
{p2colset 8 50 50 8}{p2col:ci2}circle{p_end}
{p2colset 8 50 50 8}{p2col:dots}circle{p_end}
{p2colset 8 50 50 8}{p2col:histback}none{p_end}
{p2colset 8 50 50 8}{p2col:histogram}circle{p_end}
{p2colset 8 50 50 8}{p2col:ilabel}none{p_end}
{p2colset 8 50 50 8}{p2col:matrix}circle{p_end}
{p2colset 8 50 50 8}{p2col:none}none{p_end}
{p2colset 8 50 50 8}{p2col:p}circle{p_end}
{p2colset 8 50 50 8}{p2col:pback}none{p_end}
{p2colset 8 50 50 8}{p2col:pbarback}none{p_end}
{p2colset 8 50 50 8}{p2col:pdotback}none{p_end}
