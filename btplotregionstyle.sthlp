...
{title:help for plotregionstyle}{break}
...
{p2colset 8 50 50 8}{p2col:boxgraph}boxgraph{p_end}
{p2colset 8 50 50 8}{p2col:bygraph}bygraph{p_end}
{p2colset 8 50 50 8}{p2col:clegend}clegend{p_end}
{p2colset 8 50 50 8}{p2col:combinegraph}matrixgraph{p_end}
{p2colset 8 50 50 8}{p2col:combineregion}combineregion{p_end}
{p2colset 8 50 50 8}{p2col:graph}graph{p_end}
{p2colset 8 50 50 8}{p2col:hbargraph}hbargraph{p_end}
{p2colset 8 50 50 8}{p2col:hboxgraph}hboxgraph{p_end}
{p2colset 8 50 50 8}{p2col:legend_key_region}legend_key_region{p_end}
{p2colset 8 50 50 8}{p2col:matrix}matrix{p_end}
{p2colset 8 50 50 8}{p2col:matrix_label}matrix_label{p_end}
{p2colset 8 50 50 8}{p2col:matrixgraph}matrixgraph{p_end}
