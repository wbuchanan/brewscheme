...
{title:help for axisstyle}{break}

{p 4 4 4}{hi:axisstyle {hline 2}} is an optional argument for {help brewtheme}.{p_end}
...
{p2colset 8 50 50 8}{p2col:Keys}Values{p_end}
     {hline 70}
{p2colset 8 50 50 8}{p2col:bar_group}horizontal_notick{p_end}
{p2colset 8 50 50 8}{p2col:bar_scale_horiz}horizontal_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:bar_scale_vert}vertical_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:bar_super}horizontal_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:bar_var}horizontal_notick{p_end}
{p2colset 8 50 50 8}{p2col:box_scale_horiz}horizontal_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:box_scale_vert}vertical_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:clegend}clegend{p_end}
{p2colset 8 50 50 8}{p2col:dot_group}horizontal_notick{p_end}
{p2colset 8 50 50 8}{p2col:dot_scale_horiz}horizontal_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:dot_scale_vert}vertical_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:dot_super}horizontal_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:dot_var}horizontal_notick{p_end}
{p2colset 8 50 50 8}{p2col:horizontal_default}horizontal_default{p_end}
{p2colset 8 50 50 8}{p2col:horizontal_nogrid}horizontal_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:matrix_horiz}horizontal_nogrid{p_end}
{p2colset 8 50 50 8}{p2col:matrix_vert}vertical_nogrid{p_end}
