...
{title:help for tickstyle}{break}

{p 4 4 4}{hi:tickstyle {hline 2}} is an optional argument for {help brewtheme}.{p_end}
...
{p2colset 8 50 50 8}{p2col:major}major{p_end}
{p2colset 8 50 50 8}{p2col:major_nolabel}major_nolabel{p_end}
{p2colset 8 50 50 8}{p2col:major_notick}major_notick{p_end}
{p2colset 8 50 50 8}{p2col:major_notickbig}major_notickbig{p_end}
{p2colset 8 50 50 8}{p2col:minor}minor{p_end}
{p2colset 8 50 50 8}{p2col:minor_nolabel}minor_nolabel{p_end}
{p2colset 8 50 50 8}{p2col:minor_notick}minor_notick{p_end}
